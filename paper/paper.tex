...
\begin{example}
    ...
    A belief set can be extracted from it by considering the lowest ranked worlds (i.e. the most plausible interpretations) under $\leq_{\mathbb{E}}$. For notation let $min(\alpha, \leq_{\mathbb{E}})$ denote the set of minimal models for the propositional formula $\alpha$ under $\leq_{\mathbb{E}}$. Then $min(\top, \leq_{\mathbb{E}}) = \{ 010, 100\}$ is the belief set associated with $\mathbb{E}$.
\end{example}
