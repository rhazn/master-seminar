...
% TODO title, "Of judges, aliens and tpos"?
\title{Total preorder in the courtroomg}
...
% TODO: check all \newpages if I need them or fix the figure problem
...
% TODO put examples with alpha: r and alpha p from before here and revise them
...
\section{Discussion}
% TODO *6,*7 seem weird, no different "strength" of evidence? maybe revising multiple time by the same evidence should that be? otherwise revising multiple times by same evidence is also weird because it changes things and is not idempotent
