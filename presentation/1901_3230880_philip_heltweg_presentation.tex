...
\begin{frame}{Research Context}
    ...
    \note{
        \begin{itemize}
            ...
            \item Agent kann mensch oder maschine sein, phylosophie oder KI
            ...
            \item One step vs iterated depending: Je nachdem ob man eine neue information betrachtet oder eine Reihe von neuen informationen
...
\begin{frame}{Research question}
    ...
    \note{
        \begin{itemize}
            \item Konditionaler Glauben Ändern: Indizien für Sachverhalt = Sachverhalt nicht direkt glauben aber bei mehr Indizien immer mehr daran glauben/immer mehr bereit sein es zu akzeptieren.
            \item Ziel des Papiers: Revisionsoperatoren besprechen für die änderung von konditionalen glauben
            \item Wie? über die definition von postulaten die diese operatoren einschränken und damit eine familie von operatoren definieren über die wir reden können
            \item postulate sind nicht zwingend, nur zur einschränkung damit wir über diese operatoren reden können
        \end{itemize}
    }
\end{frame}
...
\begin{frame}{Courtroom example \footnote{inspired by \cite{Booth2011} and \cite{Darwiche1997}}}
    ...
    \note{
        \begin{itemize}
            ...
            \item Aussagenlogik, Aussagenlogische Signatur mit Aussagenvariablen p, q, r
...
\begin{frame}{Belief Sets}
    ...
    \note{
        \begin{itemize}
            \item Belief sets als aktuell als wahr akzeptierte Sätze eines Agenten
            \item deduktiv abgeschlossen
            \item Gegensatz zu konditionalen glauben: Sätze im Belief set werden als war angenommen.
...
\begin{frame}{Epistemic States}
    \begin{itemize}
        ...
        \item belief sets $B(\mathbb{E})$ can be extracted from epistemic states as all sentences true in the most plausible worlds
              ...
              \end{itemize}
    \end{itemize}
    % TODO very complex, make shorter?
    \note{
        \begin{itemize}
...
\begin{frame}{Courtroom example: Revision 2}
    \begin{itemize}
        ...
        \item $\leq_{\alpha}^{\ast}$ as representation of the conditional beliefs
              \begin{itemize}
                  \item before $010 \leq 110$: "Both suspects being the murderer is less plausible than only Mary being the murderer"
