...
\begin{frame}{Courtroom example \footnote{inspired by \cite{Booth2011} and \cite{Darwiche1997}}}
    ...
    \begin{itemize}
        ...
        \item Lower case greek letters often used for propositional sentences $\alpha$
    \end{itemize}

    \note{
        \footnotesize
        \begin{itemize}
            \item Konsistentes Beispiel in der Präsentation, der Agent ist ein Richter in einem Mörderprozess vor Gericht, John und Marry sind verdächtige und das Opfer könnte ein alien sein
            ...
            \item Aussagenlogische formeln als griechische buchstaben
...
\begin{frame}{Epistemic States}
    ...
    \note{
        \begin{itemize}
            \item Darwiche and Pearl argumentieren das Belief sets nicht ausreichend sind.
            \item Die Postulate von AGM definieren nur wie sich belief sets ändern (prinzip of least change/geringste änderung) aber conditional beliefs können sich ändern wie sie wollen.
            \item Epistemic states enthalten die Strategie des Agenten wie er seinen Glauben ändert, damit auch die conditional beliefs.
...
\begin{frame}{Enriching Epistemic States}
    ...
    \note{
        \begin{itemize}
            \item zusätzliche struktur um plausibilität von welten in W nach neuer information zu modelieren
