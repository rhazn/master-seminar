...
\begin{frame}{Family of BM Revision Operators}
    ...
    \note{
        \begin{itemize}
            \item theorem definiert die familie von operatoren die booth und meyer diskutieren
            \item funktionen * die aus einer tpo und einer formel in L eine neue tpo erzeugen
            \item generiert aus den vorgestellten strukturen wenn sie postulate erfüllt
        \end{itemize}
    }
\end{frame}
