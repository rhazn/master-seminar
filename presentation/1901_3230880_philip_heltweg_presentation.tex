...
\begin{frame}{Motivation}
    ...
    \note{
        \begin{itemize}
            \item Beispiel Frage zur Motivation
            ...
            \item Keine reine richtig/falsch Frage. Soll neuer Information immer geglaubt werden? Wie sollen Konflikte gelöst werden?
        \end{itemize}
    }
\end{frame}

\begin{frame}{Courtroom example \footnote{inspired by Booth and Meyer \cite{Booth2011} and Darwiche and Pearl \cite{Darwiche1997}}}
    \begin{itemize}
...
\begin{frame}{Goal}
    \begin{itemize}
        ...
        \item discuss properties and edge cases
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item belief sets $B(\mathbb{E})$ can be extracted from epistemic states as all sentences true in the most plausible worlds
            \begin{itemize}
                ...
                \item All sentences true in those worlds: $Th(\modelsOf{B(\mathbb{E})})$
            \end{itemize}
    \end{itemize}
