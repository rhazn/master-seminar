...
\begin{frame}{Enriching Epistemic States}
    \begin{itemize}
        \item Additional structure of plausibility of worlds under new evidence $W^{\pm} = \{x^{\epsilon} \mid x \in W \textrm{ and } \epsilon \in \{+, -\}\}$
...
\begin{frame}{$\leq$-faithful tpo}
    \begin{itemize}
        ...
        \item additional structure $\preceq$ over new $W^{\pm}$
    \end{itemize}
